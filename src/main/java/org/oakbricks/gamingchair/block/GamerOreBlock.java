...
import org.oakbricks.gamingchair.item.GamerIngotItem;
...
public class GamerOreBlock extends GamingChairModElements.ModElement {
	@ObjectHolder("gaming_chair:gamer_ore")
	public static final Block block = null;
	public GamerOreBlock(GamingChairModElements instance) {
		super(instance, 9);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GamerIngotItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getGeneration().getFeatures(GenerationStage.Decoration.UNDERGROUND_ORES).add(() -> new OreFeature(OreFeatureConfig.CODEC) {
			...
			public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
				...
				if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("gaming_chair:blueworld")))
