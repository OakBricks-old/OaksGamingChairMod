...
package org.oakbricks.gamingchair.world.biome;
...
public class DiamondFieldOakBrickschairmodBiome extends GamingChairModElements.ModElement {
	public static Biome biome;
	public DiamondFieldOakBrickschairmodBiome(GamingChairModElements instance) {
		super(instance, 7);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-1307109407).setWaterColor(-1308560654).setWaterFogColor(-1306556023)
						.withSkyColor(-1307109407).withFoliageColor(-1292763136).withGrassColor(-1296679105)
						.setAmbientSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("music.credits")))
						...
						.setMusic(new BackgroundMusicSelector(
								...
								12000, 24000, true))
						.setParticle(new ParticleEffectAmbience(ParticleTypes.END_ROD, 0.004f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.DIAMOND_ORE.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.EMERALD_BLOCK.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.AMBIENT, new MobSpawnInfo.Spawners(EntityType.ZOMBIE, 20, 4, 9));
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.WOLF, 38, 14, 22));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ZOMBIE, 12, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("gaming_chair:diamond_field_oak_brickschairmod"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("diamond_field_oak_brickschairmod_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, Blocks.LADDER.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("diamond_field_oak_brickschairmod_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("diamond_field_oak_brickschairmod_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
