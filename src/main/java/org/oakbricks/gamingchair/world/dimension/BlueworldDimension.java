...
package org.oakbricks.gamingchair.world.dimension;

import org.oakbricks.gamingchair.item.BlueworldItem;
...
public class BlueworldDimension extends GamingChairModElements.ModElement {
	@ObjectHolder("gaming_chair:blueworld_portal")
	public static final CustomPortalBlock portal = null;
	public BlueworldDimension(GamingChairModElements instance) {
		super(instance, 6);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("gaming_chair:blueworld"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("blueworld_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("blueworld_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("blueworld_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlueworldItem().setRegistryName("blueworld"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("gaming_chair:blueworld"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("gaming_chair:blueworld")));
				} else {
					entity.func_242279_ag();
